...
def print_banner():
    banner = pyfiglet.figlet_format("discord-chat", font="doom")
    print(Fore.CYAN + banner)
    print(Fore.WHITE + "=" * 50)
    print(Fore.CYAN + "Discord Auto Chat Bot")
    print(Fore.CYAN + "GitHub: https://github.com/doelsumbing87")
    print(Fore.WHITE + "=" * 50 + "\n")
...
def main():
    ...
    delete_after_send = input(Fore.CYAN + "Delete messages after sending? (yes/no): ").strip().lower() == "yes"
            ...
            if r.status_code == 200:
                ...
                if delete_after_send:
                    ...
                    if delete_response.status_code == 204:
                        log_message(f"Message with ID {message_id} deleted", "SUCCESS")
                    else:
                        log_message(f"Failed to delete message: {delete_response.status_code}", "ERROR")
            else:
